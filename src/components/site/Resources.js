const Resources = () => {
    ...
    <div className="main">
        <div className="mainDiv">
            ...
            <p>Below are some resources that we used throughout this app. Note: You'll have one challenge where you will be asked to make this page better.</p>
            <ul>
                <li>
                ...
                <li>
                    <a href="https://www.pluralsight.com/course/react-js-getting-started" target="_blank">
                        Samer Buna's Pluralsight Course for the Gihub API Starter
                    </a>
                </li>
                <li>
                    <a href="https://www.udemy.com/course/react-the-guide-incl--redux" target="_blank">
                        Maximillian Scharzmueller's Udemy Course
                    </a>
                </li>
                <li>
